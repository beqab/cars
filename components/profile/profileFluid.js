...
import {Doors, Engin, Pessengers, OilType, Location, Category, Producer, CarModel} from "../selects";
...
class ProfileFluid extends Component {
    ...
    setEsDefault = (i) => {
        this.setState((prev) => ({
            images: [prev.images[i], ...prev.images.filter((el, index) => (index !== i ? el : null))],
        }));
    };
    ...
    saveStatement = () => {
        ...
        this.state.signailzation && image.append("signailzation", this.state.signailzation);
        this.state.centralLock && image.append("centralLock", this.state.centralLock);
        this.state.bortComp && image.append("bortComp", this.state.bortComp);
        this.state.conditioner && image.append("conditioner", this.state.conditioner);
        this.state.antiMocureb && image.append("antiMocureb", this.state.antiMocureb);
        this.state.parcingConttrol && image.append("parcingConttrol", this.state.parcingConttrol);
        this.state.backVision && image.append("backVision", this.state.backVision);

        // rentTypeChecboxes
        this.state.finalPurchase && image.append("finalPurchase", this.state.finalPurchase);
        ...
        image.append(
            "userName",
            typeof this.state.userName === "string" ? this.state.userName : this.props.user && this.props.user.name,
        );
        image.append(
            "phone",
            typeof this.state.phone === "string" ? this.state.phone : this.props.user && this.props.user.phone,
        );
        image.append(
            "email",
            typeof this.state.email === "string" ? this.state.email : this.props.user && this.props.user.email,
        );
        ...
        return (
            <>
                <div className="profile_main_content">
                    ...
                    >
                        <span>
                            {!this.state.statementId ? "განცხადება წარმატებით დაემატა..." : "განცხადება ჩასწორებულია"}
                        </span>
                    </div>
                    ...
                    {this.state.statementId && (
                        <h2 className="text-center m-4 redact_title">განცხადების რედაქტირება</h2>
                    )}
                    ...
                    <div className="profile_main_inputs">
                        <div className="profile_input_box">
                            <div>
                                ...
                                <Category value={this.state.category} changeHandlerfn={this.changeHandler} />
                            </div>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <select name="carAge" value={this.state.carAge} onChange={this.changeHandler}>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <Producer value={this.state.producer} changeHandlerfn={this.changeHandler} />
                            </div>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <Location value={this.state.location} changeHandlerfn={this.changeHandler} />
                            </div>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <Pessengers value={this.state.Pessengers} changeHandlerfn={this.changeHandler} />
                            </div>
                        </div>

                        <div className="profile_input_box">
                            <div>
                                <label className="select_with_img engine_select">ძრავის მოცულობა</label>
                                <Engin value={this.state.engin} changeHandlerfn={this.changeHandler} />
                            </div>
                        </div>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <OilType value={this.state.oilType} changeHandlerfn={this.changeHandler} />
                            </div>
                        </div>
                        ...
                        <div className="profile_input_box">
                            <div>
                                ...
                                <Doors value={this.state.doors} changeHandlerfn={this.changeHandler} />
                            </div>
                        </div>
                    </div>
                  ...
                  <input type="text" />
                    ...
                    <div className="price_info_fluid">
                        <div className="price_box">
                            ...
                            {this.state.priceError ? <span className="error_msg">{this.state.priceError}</span> : null}
                        </div>
                    ...
                    <div className="contact_info_fluid">
                        ...
                        <div className="up_button_fluid">
                            <button onClick={this.saveStatement} className="up_button">
                                {this.state.statementId ? " განცხადების რედაქტირება" : "გამოქვეყნება"}
                            </button>
                        </div>
                    </div>
                </div>

                ...
                <div className="profile_fluid">
                        ...
                        <div className="profile_left_tabs">
                            <ul>
                                <li>
                                    ...
                                    <a
                                        onClick={(e) => this.redirectHadler(e, "/profile/addStatement")}
                                ...
                                <li>
                                    ...
                                    <a
                                        onClick={(e) => this.redirectHadler(e, "/profile/allStatement")}
                                        className={Classnames({
                                            active: pageType === "allStatement",
                                        })}
                                    >
                                        <span>ჩემი განცხადებები</span>
                                        <span className="right_circle">{this.state.statementSum}</span>
                                    </a>
                                    {/* </Link> */}
                                </li>
                                {/* <li>
                  <a href="">
                    ...
                    {pageType === "addStatement" ? (
                        <ProfileFluid changeStaenmansSum={(type) => this.changeStaenmansSum(type)} />
                    ) : pageType === "allStatement" ? (
                        <MyStatements changeStaenmansSum={(type) => this.changeStaenmansSum(type)} />
                    ) : pageType === "info" ? (
                        <PersonalInfo />
                    ) : (
                        "ups :/"
